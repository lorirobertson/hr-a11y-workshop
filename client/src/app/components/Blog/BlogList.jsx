...
class BlogList extends React.Component {
  ...
  buildParamsObject() {
    let params = {
      _limit: this.props.itemsPerPage,
      _start: this.state.paging.currentIndex,
      _sort: this.state.sort,
      title_contains: this.state.filter,
  ...
  countPosts() {
    ...
    request.get(`/posts/count`, this.buildParamsObject())
      .then((resp)=>{
        ...
        paging.totalNumPosts = resp.data;
  ...
  toggleSort() {
    let sort = ( this.state.sort === 'created:desc' ) ? 'created:asc' : 'created:desc';
  ...
  render() {
    ...
    const sortDirectionClass = ( this.state.sort !== 'created:desc' ) ? 'up' : 'down';
    return (
        <div id="posts">
