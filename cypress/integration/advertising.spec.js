describe('Apartment Therapy - Advertising Site', () => {
  it('Test advertising homepage for a11y', () => {
    // First, we visit the page we intend to analyze
    cy.visit('https://advertising.apartmenttherapy.com/');
    ...
    cy.getAxeResults().then(results => {
      ...
      cy.writeFile(`${resultsDir}/advertising.json`, results)
